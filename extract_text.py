# Import libraries
# file location r'E:\Lime Survey\Resource\img_files\(参考)公共図書館における障害者サービスに関する調査研究(H30.8国会図書館)質問紙-01.jpg'
...
def show_extract_button(path):
    extractBtn = Button(root, text="Extract text", command=lambda: extract(path), bg="#2f2f77", fg="gray", pady=15,
